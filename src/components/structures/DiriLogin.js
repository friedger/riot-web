...
import Login from "matrix-react-sdk/lib/Login";
import SdkConfig from "matrix-react-sdk/lib/SdkConfig";
import { messageForResourceLimitError } from "matrix-react-sdk/lib/utils/ErrorUtils";
...
module.exports = React.createClass({
    ...
    componentWillMount: function() {
        ...
        this._stepRendererMap = {
            ...
            "m.login.cas": () =>
                this._renderSsoStep(this._loginLogic.getSsoLoginUrl("cas")),
            "m.login.sso": () =>
                this._renderSsoStep(this._loginLogic.getSsoLoginUrl("sso"))
        };
    ...
    onPasswordLogin: function(username, phoneCountry, phoneNumber, password) {
        ...
        if (this.state.discoveryError || this.props.defaultServerDiscoveryError)
            return;
                                ...
                                <div>
                                    ...
                                    <div className="mx_Login_smallError">
                                        {_t(
                                            ...
                                            {
                                                hs: this.props.defaultHsUrl.replace(
                                                    /^https?:\/\//,
                                                    ""
                                                )
                                            }
            ...
            .then(
                ...
                function(error) {
                    ...
                    if (error.httpStatus === 403) {
                        errorText = _t(
                            "Guest access is disabled on this homeserver."
                        );
                    } else {
    ...
    onUsernameBlur: function(username) {
        ...
        if (username[0] === "@") {
            ...
            try {
                ...
                this.setState({
                    discoveryError: _t("Failed to perform homeserver discovery")
                });
            }
        }
    },
        ...
        try {
            ...
            if (
                ...
                this.onServerConfigChange({
                    ...
                    isUrl:
                        discovery["m.identity_server"].state ===
                ...
                console.warn(
                    "Unknown state for m.homeserver in discovery response: ",
                    discovery
                );
                this.setState({
                    discoveryError: _t(
                        "Unknown failure discovering homeserver"
                    ),
                    findingHomeserver: false
                });
            }
    ...
    _renderSsoStep: function(url) {
        ...
        return (
            <a href={url} className="mx_Login_sso_link mx_Login_submit">
    ...
    render: function() {
        ...
        const errorText =
            this.props.defaultServerDiscoveryError ||
            this.state.discoveryError ||
